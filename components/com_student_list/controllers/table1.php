 ...
 */
class Student_listControllerTable1 extends Student_listController
{
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Table1', 'Student_listModel');
		...
		$this->setRedirect(JRoute::_('index.php?option=com_student_list&view=table1form&layout=edit', false));
	}
